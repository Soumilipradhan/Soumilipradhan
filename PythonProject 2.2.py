...
path='C:\Users\Soumili\Documents\PythonProject 2.2.py'
print('-'*50)
...
def get_batch():
    with open(f'C:\Users\Soumili\Documents\PythonProject 2.2.py'/Batch.csv','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:\Users\Soumili\Documents\PythonProject 2.2.py'/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
